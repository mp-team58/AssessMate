...
import { LayoutDashboard, FileText, KeyRound, LogOut, Menu, X, BookOpenCheck } from 'lucide-react';
...
const CandidateLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'My Assessments', path: '/candidate/my-assessments', icon: FileText },
    { name: 'Join Assessment', path: '/candidate/join', icon: KeyRound },
  ];
        ...
        <div className="p-4 border-t border-secondary-700/50 space-y-2">
          <div className="px-4 py-3 bg-secondary-900/50 rounded-xl border border-secondary-700/50 flex items-center gap-3">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-xs text-secondary-400 font-medium">Candidate</p>
            </div>
          </div>
